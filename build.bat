...
docker run --name a3-server -p 2302:2302/udp -p 2303:2303/udp -p 2304:2304/udp -p 2305:2305/udp -p 2306:2306/udp -v C:/Users/Adam/dev/cloud-server-tool/lib/python:/home/gameuser -it arma-server
