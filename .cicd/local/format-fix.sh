...
# cloud_server_tool
/bin/bash .cicd/bash/linters/python-format.sh .cicd/python lib/python/cloud_server_tool cloud_server_tool "" lib/python/cloud_server_tool/pyproject.toml /root/venvs/cst/bin/python3